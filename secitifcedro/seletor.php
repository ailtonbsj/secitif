...
<div id="wrap">
    ...
    <h2 class="titulo">Selecione o evento ao qual vai participar:</h2>
    <ul id="box">
    <li><a href="certificado.php"><img src="images/box_5.gif" width="567" height="134" /></a></li>
   	  <li><a href="confirmemail.php?evt=F"><img src="images/box_1.gif" width="567" height="134" /></a></li><!-- confirmemail.php?evt=F -->
        <li><a href="confirmemail.php?evt=M"><img src="images/box_2.gif" width="567" height="134" /></a></li><!-- confirmemail.php?evt=M -->
        <li><a href="sys_simposio.php"><img src="images/box_3.gif" width="567" height="134" /></a></li>
        <li><a href="seletor_comp.php"><img src="images/box_4.gif" width="567" height="134" /></a></li><!-- seletor_comp.php -->
    </ul>
