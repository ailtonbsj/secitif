...
<div id="wrap">
    ...
    <h1>Downloads</h1>
    <ul>
   	  <li>I Simpósio Técnico</li>
        <ul>
        	<li><a href="downloads/edital_simposio.pdf">Baixar Edital do I Simpósio Técnico</a></li>
            <li><a href="downloads/modelo_artigo_simposio.docx">Baixar Modelo de Artigo em Word 2003</a></li>
            <li> <a href="downloads/edital_corridamecanica.pdf">Baixar Edital da I Corrida Mecânica</a></li>
            <li><a href="downloads/edital_maratona_programacao.pdf">Baixar Edital da I Maratona de Programação</a></li>
            <li><a href="downloads/edital_competicao_eletrotecnica.pdf">Baixar Edital da I Competição da Eletrotécnica</a></li>
            <li><a href="downloads/cronograma_apresentacao_artigos.pdf">Datas de Apresentaç&otilde;es de Artigos do I Simpósio</a> <span style="background-color: #F00; color: #FFF; font-weight: bold;">Novo!!!</span></li>
      </ul>
      <li>VI FEMECI</li>
      <ul>
      		<li><a href="downloads/edital_robomect.pdf">Baixar Edital da competição de Robótica (II ROBOMECT)</a></li>
      </ul>
      <li>Encontro da Matemática</li>
      <ul>
      		<li><a href="downloads/edital_xadrez.pdf">Baixar Edital do I Campeonato de Xadrez</a></li>
      </ul>
    </ul>
