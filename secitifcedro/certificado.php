...
<div id="wrap">
	...
	{
	?>
    <p>Antes de continuar verifique se seu nome está completo e digitado de forma correta sem acentos.</p>
    <h3><?php echo $row_Recordset1['nome']; ?> <?php echo $row_Recordset1['sobrenome']; ?></h3>
	<p>Seu NOME COMPLETO está correto? <button onclick="location.href='emite_cert.php';">SIM</button> <button onclick="location.href='alter_name.php';">NÃO</button></p>
</p>
	<?php
	} else {
	?>
    Você não participou de nenhum curso!
	<?php
	}
	?>
