...
<div id="wrap">
    ...
    <h1>Parabéns!!!</h1>
    <p><?=$_GET["nome"];?>, você já está cadastrado no sistema do SECITIF!</p>
    <p>Seu login é: <?=$_GET["email"];?></p>
    <p>Sua senha é: ******</p>
    <p>Um email de confirmacao foi enviado para seu email.<p>
    <div class="box_alerta"><b>Atenção:</b> Caso não encontre o email na Caixa de Entrada verifique a <i>caixa de SPAN.</i><br />
    Caso não tenha recebido o email de confirmação por favor entrar em contato!</div>
