...
<div id="wrap">
    ...
    <h1>Digite seu nome COMPLETO SEM ACENTOS e SEM CARACTERES ESPECIAIS:</h1>
    <form id="form1" action="processor.php" method="post">
    Nome <input name="nome" type="text" id="nome"  style="width: 200px;" value="<?php echo $row_Recordset1['nome']; ?>"/> Sobrenome <input name="sobrenome" type="text" id="sobrenome"  style="width: 200px;" value="<?php echo $row_Recordset1['sobrenome']; ?>"/>
    <br /><br />
