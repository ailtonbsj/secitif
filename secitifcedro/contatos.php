...
<div id="wrap">
	...
	if(isset($_GET["sendmail"])){
		echo "<div class=\"box_ok\">Seu Email foi enviado!!!!</div>";
	}
	?>
    <form action="http://www.cedro.ifce.edu.br/sendmail_.php" method="get">
    <h1>Entre em contato!</h1>
    Seu nome <input type="text" name="nome" id="nome" />
    Seu email <input type="text" name="mail" id="mail" />
    Assunto <input type="text" name="ass" id="ass" />
	Mensagem <textarea name="sms" id="sms" cols="45" rows="5"></textarea>
    <input type="submit" name="button" id="button" value="Enviar Email" />
    </form>
    <div class="box_alerta">Fale conosco e receba informações também pelo Facebook acessando a pagina <a href="http://www.facebook.com/secitifcedro">http://www.facebook.com/secitifcedro</a></div>
